        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, cursor: "pointer" }} onClick={reset}>
              ...
              <div>
                <div style={{ fontSize: 24, fontWeight: 700, color: C.white, fontFamily: "'Playfair Display', serif", letterSpacing: 0.2 }}>Gudreview</div>
        ...
        <div className="hero-grid">
          <ShellCard style={{ padding: 22 }}>
            ...
            <div style={{ marginTop: 14, color: C.muted, fontSize: 15, lineHeight: 1.8, maxWidth: 740 }}>
              Paste a Google Maps restaurant link, optionally add Yelp for exact matching, and gudreview will collect reviews,
